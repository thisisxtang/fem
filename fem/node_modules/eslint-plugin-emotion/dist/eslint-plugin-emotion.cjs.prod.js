...
function isStringStyle(node) {
  if ("TaggedTemplateExpression" === node.type) {
    if (
      ...
      return !0;
    if ("CallExpression" === node.tag.type && "styled" === node.tag.callee.name)
      return !0;
  }
  return !1;
}
...
var MSG_PREFER_STRING_STYLE = "Styles should be written using strings.",
    ...
    create: function(context) {
      return {
        TaggedTemplateExpression: function(node) {
          ...
          isStringStyle(node) &&
            "object" === preferedSyntax &&
            context.report({ node: node, message: MSG_PREFER_OBJECT_STYLE });
        },
        CallExpression: function(node) {
          var preferedSyntax = context.options[0];
          isObjectStyle(node) &&
            "string" === preferedSyntax &&
            context.report({ node: node, message: MSG_PREFER_STRING_STYLE });
        }
      };
    }
  },
  ...
  src = { rules: rules };
(exports.default = src), (exports.rules = rules);
